...
\item{A solution to the problem presented with parts of the code left blank for students to fill in.}
...
\item{Building a MiniJava representation of the solution.}
\item{Making some portions of the solution blank.}
\item{Calculating the difficulty of the current problem, given how difficult the question is to answer and how much of the solution is blank.}
...
The \texttt{String} field, \texttt{question}, stores the question provided to students. This field is initialised in the constructor. 

\subsubsection*{2. Building a MiniJava representation of the solution}

\subsubsection*{3. Making some portions of the solution blank}

\subsubsection*{4. Calculating the difficulty of the current problem}

\subsubsection*{5. Adding and removing blanks from the solution}

\subsubsection*{6. Filling blanks with student submitted code}

\subsubsection*{7. Executing the solution}

\subsubsection*{8. Checking that the problem is solved by the provided solution}

...
public class WhileStmntTest {
    ...
    VarDeclarator i0, sum0, j0, nsInit;
    ArrayInit nsInitR;
    ...
    public void setUp() throws Exception {
        ...
        i0.setUpVarDec("i", false, zero);
        sum0 = new VarDeclarator();
        sum0.setUpVarDec("sum", false, zero);
        one = new Literal();
        ...
        nsInitR = new ArrayInit();
        nsInitR.addExpression(one);
        nsInitR.addExpression(two);
        nsInitR.addExpression(three);
        nsInitR.addExpression(four);
        nsInit = new VarDeclarator();
        nsInit.setUpVarDec("ns", true, nsInitR);

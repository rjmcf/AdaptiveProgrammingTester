...
public class IfThenElseStmntNoShortIfTest {
    Context c;
    Block block1, block2;
    IfThenElseStmntNoShortIf iTES1, iTES2;
    LocalVarDec iE, jE;
    ...
    public void setUp() throws Exception {
        ...
        iTES1 = new IfThenElseStmntNoShortIf();
        iTES1.setUpITENSI(t, eS1, eS2);
        ...
        iTES2 = new IfThenElseStmntNoShortIf();
        iTES2.setUpITENSI(f, eS3, eS4);
